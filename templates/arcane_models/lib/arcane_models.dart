...
export 'package:arcane_models/gen/artifacts.gen.dart';
export 'package:arcane_models/gen/crud.gen.dart';
...
@model
class ArcaneServerSignature {
  final String signature;
  final String session;
  final int time;

  ArcaneServerSignature({
  ...
  static ArcaneServerSignature newSignature() => ArcaneServerSignature(
