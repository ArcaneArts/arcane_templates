...
import 'package:arcane_dock_app/screens/dock_screen.dart';
import 'package:arcane_dock_app/util/window_manager.dart';
...
void main() async {
  try {
    ...
    runApp("arcane_dock_app", const ArcaneDock());
  } catch (e, stackTrace) {
    error("FATAL ERROR: $e");
...
Future<void> _initializeApp() async {
  ...
  success("Arcane Dock initialized successfully");
  success("=====================================");
}
...
Future<void> _setupLogging() async {
  final File logFile = File("$configPath/arcane_dock_app.log");
