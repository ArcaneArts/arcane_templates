library {{name.snakeCase()}}_models;
...
import 'package:{{name.snakeCase()}}_models/gen/artifacts.gen.dart';

export 'package:{{name.snakeCase()}}_models/gen/artifacts.gen.dart';
export 'package:{{name.snakeCase()}}_models/gen/crud.gen.dart';
...
@model
class {{class_name.pascalCase()}}ServerSignature {
  final String signature;
  final String session;
  final int time;

  {{class_name.pascalCase()}}ServerSignature({
  ...
  static {{class_name.pascalCase()}}ServerSignature newSignature() => {{class_name.pascalCase()}}ServerSignature(
